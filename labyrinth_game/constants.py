...
ROOMS = {
    ...
    "garden": {
        "description": (
            "Заброшенный внутренний сад под обвалившимся потолком. "
            "Пахнет сыростью и травами."
        ),
        "exits": {
            "west": "hall",
            "north": "crypt",
    ...
    "crypt": {
        "description": (
            "Склеп с каменными нишами. На полу видны царапины, будто что-то тащили."
        ),
        "exits": {"south": "garden"},
        "items": ["note"],
        "puzzle": ("На стене выбито: 'Сколько сторон у квадрата?'", "4"),
    },
}
